...
public final class MongoDBConnectionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcConnection.ReplicateRequest,
      com.example.grpcConnection.ReplicateResult> getReplicateOplogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReplicateOplog",
      requestType = com.example.grpcConnection.ReplicateRequest.class,
      responseType = com.example.grpcConnection.ReplicateResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.grpcConnection.ReplicateRequest,
      com.example.grpcConnection.ReplicateResult> getReplicateOplogMethod() {
    io.grpc.MethodDescriptor<com.example.grpcConnection.ReplicateRequest, com.example.grpcConnection.ReplicateResult> getReplicateOplogMethod;
    if ((getReplicateOplogMethod = MongoDBConnectionGrpc.getReplicateOplogMethod) == null) {
      synchronized (MongoDBConnectionGrpc.class) {
        if ((getReplicateOplogMethod = MongoDBConnectionGrpc.getReplicateOplogMethod) == null) {
          MongoDBConnectionGrpc.getReplicateOplogMethod = getReplicateOplogMethod =
              io.grpc.MethodDescriptor.<com.example.grpcConnection.ReplicateRequest, com.example.grpcConnection.ReplicateResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReplicateOplog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcConnection.ReplicateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcConnection.ReplicateResult.getDefaultInstance()))
              .setSchemaDescriptor(new MongoDBConnectionMethodDescriptorSupplier("ReplicateOplog"))
              .build();
        }
      }
    }
    return getReplicateOplogMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.example.grpcConnection.ReplicateRequest> replicateOplog(
        io.grpc.stub.StreamObserver<com.example.grpcConnection.ReplicateResult> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getReplicateOplogMethod(), responseObserver);
    }
  }
  ...
  public static final class MongoDBConnectionStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.grpcConnection.ReplicateRequest> replicateOplog(
        io.grpc.stub.StreamObserver<com.example.grpcConnection.ReplicateResult> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(
          getChannel().newCall(getReplicateOplogMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_REPLICATE_OPLOG = 1;
      ...
      switch (methodId) {
        case METHODID_EXECUTE_COMMAND:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.executeCommand(
              (io.grpc.stub.StreamObserver<com.example.grpcConnection.CommandExecutionResult>) responseObserver);
        case METHODID_REPLICATE_OPLOG:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.replicateOplog(
              (io.grpc.stub.StreamObserver<com.example.grpcConnection.ReplicateResult>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.example.grpcConnection.ReplicateRequest,
              com.example.grpcConnection.ReplicateResult>(
                service, METHODID_REPLICATE_OPLOG)))
        .build();
  }
      ...
      synchronized (MongoDBConnectionGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getReplicateOplogMethod())
              .build();
        }
      }
    }
